...
class Links(models.Model):
    ...
    target = models.CharField(u'链接的打开方式', max_length=200, default="")
    ...
    rel = models.CharField(u'XFN关系', max_length=255, default="")
    notes = models.CharField(u'XFN注释', max_length=255, default="")
    rss = models.CharField(u'链接RSS地址', max_length=255, default="")
    ...
    def get_absolute_url(self):
        return ('delete_friend_links', (), {'authorname':self.owner.user.username, 'pk':self.pk})
